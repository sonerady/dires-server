...
IMPORTANT: Your response must be ONLY the prompt itself with no additional commentary or introductory phrases. The prompt must be in English (regardless of what language the user description is in) and limited to 150 words.`,
          },
        ];
