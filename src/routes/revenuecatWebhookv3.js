...
router.post("/webhookv3", async (req, res) => {
  try {
    ...
    // grant trial_credits (default 1000) instead of full package credits.
    ...
    if (period_type === "TRIAL" && type === "INITIAL_PURCHASE") {
      ...
      console.log(
        `🎉 [RC_WEBHOOK_V3] Trial-to-Paid CONVERSION detected (is_trial_conversion=true) → granting full ${packageCredits} credits (trial 1000 bonus preserved on top)`,
      );
