...
router.post("/generate-unboxing-story", async (req, res) => {
    ...
    try {
        ...
        const scene1 = up.scene_1_instruction || 'Hands holding a premium fashion brand package box at home — a sturdy garment-sized box made of thick matte cardstock with crisp clean edges, modern minimalist branding (debossed or subtly printed logo), satin or grosgrain ribbon, optional magnet-closure flap. Style and color of the box should harmonize with the product — refined luxury fashion packaging in the spirit of Zara, COS, Aritzia, Mango or Net-a-Porter. The box must look BRAND-NEW: no scuff marks, no creases, no worn corners, no plain shipping cardboard texture. NOT a generic brown shipping carton, NOT a flimsy mailer bag, NOT an oversized warehouse box. Excited unboxing moment, cozy indoor setting on couch or bed.';
...
{"scene_1":"transform ...","scene_2":"transform ...","scene_3":"transform ...","scene_4":"transform ...","scene_5":"transform ...","scene_6":"transform ..."}`;
        ...
        const scenePrompts = [
            prompts.packageArrived || `convert to hands holding a premium garment-sized fashion brand package box at home on couch or bed — sturdy thick matte cardstock construction with crisp clean edges, modern minimalist branding (debossed or subtly printed logo), satin or grosgrain ribbon, optional magnet-closure flap, refined luxury fashion packaging in the spirit of Zara, COS, Aritzia, Mango or Net-a-Porter. The box must look BRAND-NEW: no scuff marks, no creases, no worn corners, no plain shipping cardboard texture. NOT a tiny jewelry box, NOT a generic brown shipping carton, NOT a flimsy mailer bag, NOT an oversized warehouse box${brandPackageNote}, the box should harmonize in tone with the garment and fit a folded garment inside, excited moment, cozy home interior background, warm indoor ambient lighting, authentic phone camera quality, raw photo only NO social media UI NO buttons NO icons NO app interface, preserve all garment details exactly`,
...
router.post("/retry-unboxing-scene", async (req, res) => {
    ...
    try {
        ...
        const defaultPrompts = [
            `convert to hands holding a premium garment-sized fashion brand package box at home on couch or bed — sturdy thick matte cardstock construction with crisp clean edges, modern minimalist branding (debossed or subtly printed logo), satin or grosgrain ribbon, optional magnet-closure flap, refined luxury fashion packaging in the spirit of Zara, COS, Aritzia, Mango or Net-a-Porter. The box must look BRAND-NEW: no scuff marks, no creases, no worn corners, no plain shipping cardboard texture. NOT a tiny jewelry box, NOT a generic brown shipping carton, NOT a flimsy mailer bag, NOT an oversized warehouse box${retryBrandNote}, the box should harmonize in tone with the garment and fit a folded garment inside, excited moment, cozy home interior background, warm indoor ambient lighting, authentic phone camera quality, raw photo only NO social media UI NO buttons NO icons NO app interface, preserve all garment details exactly`,
