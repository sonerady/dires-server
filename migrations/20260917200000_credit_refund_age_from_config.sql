-- Yaş penceresi app_config.refund_max_age_days'ten okunsun. Fonksiyon değeri
-- zaten age_days'e alıyordu ama kullanmıyordu; pencere '24 hours' olarak
-- koda gömülüydü. Config 1 olduğu sürece davranış birebir aynı kalır.
...
begin
 ...
 -- Initial claims are visual-only; free text is accepted by the appeal endpoint.
